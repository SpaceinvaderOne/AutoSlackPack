...
RUN slackpkg install binutils gcc-g++ libffi glibc libunistring elfutils guile make gc kernel-headers gcc && \
    ...
    slackpkg install nano coreutils fileutils findutils gawk sed grep gettext util-linux cmake meson ninja ncurses ncurses-devel zlib zlib-devel openssl openssl-devel mesa mesa-devel libX11 libX11-devel libXext libXext-devel libxcb libxcb-devel libXau libXau-devel libXdmcp libXdmcp-devel eudev
